...
class ManajemenPeminjaman extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin-perpus.manajemen-peminjaman', [
            'loans' => $loans,
        ]);
    } 
    ...
    private function loadSelectedLoan(): void
    {
        ...
        $loan = Peminjaman::with(['items.buku', 'siswa.user', 'siswa.kelas', 'adminPerpus.user', 'penalties.adminPerpus.user'])
        ...
        return [
            ...
            'penalties' => $loan->penalties->map(function ($penalty) {
                return [
                    ...
                    'admin_perpus' => $penalty->adminPerpus?->user?->nama_user,
                ];
            })->values()->all(),
        ];
    }
