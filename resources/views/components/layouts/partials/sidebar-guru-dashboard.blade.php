    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a wire:navigate href="{{ route('guru.dashboard') }}"><img src="{{ asset('assets/compiled/svg/logo.svg') }}"
                            alt="Logo" srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Request::routeIs('guru.dashboard') ? 'active' : '' }} ">
                    <a wire:navigate href="{{ route('guru.dashboard') }}" class='sidebar-link'>
                ...
                <li class="sidebar-item {{ Request::routeIs('guru.scan-peminjaman') ? 'active' : '' }} ">
                    <a wire:navigate href="{{ route('guru.scan-peminjaman') }}" class='sidebar-link'>
                        <i class="bi bi-qr-code-scan"></i>
                        <span>Scan Peminjaman</span>
                    </a>
                </li>
                <li class="sidebar-item {{ Request::routeIs('guru.scan-pengembalian') ? 'active' : '' }} ">
                    <a wire:navigate href="{{ route('guru.scan-pengembalian') }}" class='sidebar-link'>
                        <i class="bi bi-arrow-counterclockwise"></i>
                        <span>Scan Pengembalian</span>
                    </a>
                </li>
                <li class="sidebar-item {{ Request::routeIs('guru.peminjaman') ? 'active' : '' }} ">
                    <a wire:navigate href="{{ route('guru.peminjaman') }}" class='sidebar-link'>
