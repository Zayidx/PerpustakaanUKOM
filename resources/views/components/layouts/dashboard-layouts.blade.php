...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('storage/assets/compiled/svg/favicon.svg') }}" type="image/x-icon">
  ...
  <link rel="stylesheet" href="{{ asset('storage/assets/compiled/css/app.css') }}">
  <link rel="stylesheet" href="{{ asset('storage/assets/compiled/css/app-dark.css') }}">
  <link rel="stylesheet" href="{{ asset('storage/assets/compiled/css/iconly.css') }}">
</head>
...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="{{ asset('storage/assets/compiled/svg/logo.svg') }}" alt="Logo" srcset=""></a>
            </div>
...
<div class="page-content"> 
    ...
    <script src="{{ asset('storage/assets/static/js/components/dark.js') }}"></script>
