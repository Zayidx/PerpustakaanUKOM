                        ...
                        <div class="card h-100">
                            <div class="card-body px-4 py-4-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-8 text-end text-md-start">
                                        <h6 class="text-muted font-semibold">Guru &amp; Petugas</h6>
                                        <h4 class="font-extrabold mb-0">{{ number_format($stats['teachers']) }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="text-muted small mb-0">Perlu ditinjau oleh petugas/guru.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
