...
<input type="text"
                ...
                <div class="col-12 col-md-auto">
                    <div class="d-grid d-md-flex justify-content-md-end">
                        <button wire:click="create"
                            ...
                            <span class="ms-1">Tambah Super Admin</span>
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">
                                {{ $super_admin_id ? 'Edit Data Super Admin' : 'Tambah Data Super Admin' }}
                            </h5>
                            ...
                            <form wire:submit.prevent="store" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="password" class="form-label">
                                                Password
                                                @if($super_admin_id) <span class="text-muted small">(Kosongkan jika tidak diubah)</span> @endif
                                            </label>
                                ...
                                <div class="modal-footer"> 
                                    ...
                                    <button type="submit" class="btn btn-primary" wire:loading.attr="disabled" wire:target="store,foto">
                                        <span wire:loading.remove>{{ $super_admin_id ? 'Simpan Perubahan' : 'Simpan' }}</span>
        ...
        <div class="table-responsive"> 
            <table class="table table-striped">
                ...
                <tbody>
                    @forelse ($this->listSuperAdmins as $item)
                        <tr wire:key="row-{{ $item->id }}"> 
                            <td class="text-center">{{ $loop->iteration + ($this->listSuperAdmins->currentPage() - 1) * $this->listSuperAdmins->perPage() }}</td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <button wire:confirm="Yakin ingin menghapus data {{ $item->user->nama_user ?? 'Super Admin' }}?"
        ...
        <div class="card-footer"> 
            <div class="d-flex justify-content-between align-items-center gap-3">
                ...
                <div>
                    {{ $this->listSuperAdmins->onEachSide(1)->links() }} 
                </div>
            </div>
        </div>
    </div>
